            ...
            <section className="bg-black   flex gap-[100px w-full h-auto p-10  ">
                ...
                <div className="flex mt-40  w-1/2 ">
                    ...
                    <div>
                        ...
                        <figure className="xl:h-[600px] lg:h-[560px] md:h-[420px] sm:h-[350px] xs:h-[260px] h-[190px] max-w-[1078px] mx-auto relative overflow-hidden">
                            {/* <Image src={Winning} alt="Winning Big Image" className="h-full w-full object-cover block" /> */}
                            <VideoPlayer className="absolute top-[50%] left-[50%] z-[1] w-[100%] h-[100%] -translate-y-[50%] -translate-x-[50%]" url={VIDEO_4} style={{ frameborder: 0 }} />
                        </figure>
                    </div>
            ...
            <section className="w-full h-full flex bg-black text-white  p-40">
                ...
                <div className="w-1/2 h-auto">
                    ...
                    <strong>
                        ...
                        Viago helps you achieve just that: more freedom in your
