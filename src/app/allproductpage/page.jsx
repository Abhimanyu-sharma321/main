...
import { _ALL_PRODUCT_IMAGES } from "../productdetails";
          ...
          {_ALL_PRODUCT_IMAGES.map((product, i) => (
            ...
            >
              ...
              <div className="p-10">
                ...
                <h1 className={`${PARAGRAPH_CLASS} mt-10`}>
                  {product.description}
                </h1>
                ...
                <i className={`${PARAGRAPH_CLASS} mt-10`}>
                  {product.suggetion}
                </i>
              </div>
              ...
              <div>
                <button
                  className="w-full h-16 bg-sky-800 text-white font-bold hover:bg-white hover:text-black hover:border border-black rounded-sm"
